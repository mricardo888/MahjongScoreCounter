...
object ShanghaiEngine {

    fun validate(input: RoundInput, rules: ScoreRules.Shanghai): ValidationError? {
    ...
    fun calculate(input: RoundInput.Fan, rules: ScoreRules.Shanghai): RoundResult {
